...
const submit = ()=> {
    form.put(route("admin.submissions.update", props.submission.id),{
          onSuccess: ()=> cleanForm ()
    });
}
...
<form @submit.prevent="submit">
    ...
    <div class="grid md:grid-cols-2 md:gap-6 p-5">
        ...
        <div class="mb-2">
            ...
            <TextInput id="fourth_dose_date"  v-model="form.fourth_dose_date" type="text" class="form-control" placeholder="dd-mm-yy"/>

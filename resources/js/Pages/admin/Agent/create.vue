    ...
    <form @submit.prevent="submit" class="w-full lg:w-6/12 mx-auto bg-gray-50 p-5 rounded-lg">
               <div class="mt-3 mb-3">
                     <img src="../../../../../public/image/bd_logo.png" alt="logo" class="w-16 h-16 mx-auto m-1 rounded-full">
                      <h3 class="text-3xl font-bold text-center m-2">ADD AGENT</h3>
               </div>
        <div>
        ...
        <div class="mt-4">
            ...
            <TextInput id="email"  v-model="form.email" type="email" class="form-control" placeholder="Enter Agent Email"  />

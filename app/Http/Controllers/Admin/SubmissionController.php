...
class SubmissionController extends Controller
{
    public function index()
    {
      ...
      $perPage = FacRequest::input('perPage') ?: 15;
     

      $submissions = SubmisstionResource::collection(Submission::query()
      ->when($inputSearch, function($query, $search){
        $query->where('name','like', "%{$search}%");})->orderBy('id', 'desc')->paginate($perPage)->withQueryString());
        
        return Inertia::render('admin/submission/index', compact('submissions','filters'));
    }
    ...
    public function edit(Submission $submission)
    {
      ...
      return Inertia::render('admin/submission/edit',compact('submission','centers' ));
    }
    ...
    public function show($id)
    {
       ...
       return Inertia::render('admin/submission/show',compact('submission'));
    }
